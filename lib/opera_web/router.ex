defmodule OperaWeb.Router do
  ...
  scope "/", OperaWeb do
    ...
    live "/admin/:user_id", EditUserLive
  end
  ...
  scope "/", OperaWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{OperaWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", OperaWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{OperaWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", OperaWeb do
    ...
    live_session :current_user,
      on_mount: [{OperaWeb.UserAuth, :mount_current_user}] do
